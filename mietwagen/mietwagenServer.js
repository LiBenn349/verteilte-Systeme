...
const mietwagenRouter = require('./routes/mietwagenRouter');//Router laden
app.use('/', mietwagenRouter);//Router unter dem vorne angegebenen Pfad verfügbar machen


//Server starten
app.listen(port, () => {
    console.log("MicroService Mietwagen wurde erfolgreich auf Port: " + port + " gestartet"); 
})
