...
const flugRouter = require('./routes/flugRouter');//Router laden
app.use('/', flugRouter);//Router unter dem vorne angegebenen Pfad verfügbar machen


//Server starten
app.listen(port, () => {
    console.log("MicroService Flugverbindung wurde erfolgreich auf Port: " + port + " gestartet");
})
